                ...
                <div className="ms5-meal-kit pt-5">
                    ...
                    <div className="ms5-mk-1 row py-4">
                        ...
                        <div className="col d-flex flex-column justify-content-center">
                            ...
                            <div className="ms5-mk-build-your-box-btn pt-3">
                                <input type="submit" value="Build Your Box" className="ms5-mk-btn"/>
                            </div>
                    ...
                    <div className="ms5-mk-2 row py-4">
                        ...
                        <div className="col d-flex flex-column justify-content-center">
                            ...
                            <p className="text-color-green text-left w-75 pt-2 font-size-1">
                                Add meals. Edit servings. Or take a week off and fly to Tahiti. Plans and preferences
                                change — we keep up
                            </p>

                            <div className="ms5-mk-plan-your-week-btn pt-3">
                                <input type="submit" value="Plan Your First Week" className="ms5-mk-btn"/>
                            </div>
                    ...
                    <div className="ms5-mk-3 row py-4">
                        ...
                        <div className="col d-flex flex-column justify-content-center">
                            ...
                            <p className="text-color-green text-left w-75 pt-2 font-size-1">
                                ...
                                masterpieces with options for veggie, low-carb or cal-conscious – you’ll find tons of
                                meals that fit your changing schedule and tastes.
                            </p>

                            <div className="ms5-mk-dig-in-btn pt-3">
                                <input type="submit" value="Dig In" className="ms5-mk-btn"/>
                            </div>
